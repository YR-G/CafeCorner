"""
Django settings for CafeCorner project.
...
SECRET_KEY = "django-insecure-ggl)c#6+nvqpfqos#=cuitqwa67la$qc+yr-otxly%nj!+a-@)"
...
WSGI_APPLICATION = "CafeCorner.wsgi.application"
